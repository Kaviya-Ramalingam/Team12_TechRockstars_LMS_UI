...
public class ClassPage {
	...
	public WebElement classLinkInNavigationBar;

	@FindBy(xpath = "//span[text()='Program']")
	public WebElement programLinkInNavigationBar;

	@FindBy(xpath = "//span[text()='Batch']")
	public WebElement batchLinkInNavigationBar;

	@FindBy(xpath = "//span[text()='Logout']")
	public WebElement logoutLinkInNavigationBar;

	@FindBy(xpath = "//app-header//span[text()=' LMS - Learning Management System ']")
	public WebElement titleInNavigationBar;

	// Class Page WebElements

	@FindBy(xpath = "//mat-card-title/div[contains(text(), 'Manage Class')]")
	public WebElement manageClassHeader;

	@FindBy(xpath = "//input[@placeholder='Search...']")
	public WebElement searchTextBox;

	@FindBy(xpath = "(//button[@ng-reflect-icon='pi pi-trash'])[1]")
	public WebElement deleteBtnUnderManageClassHeader;

	// Table Header WebElements

	@FindBy(xpath = "//table//th[contains(text(),'Batch Name')]")
	public WebElement batchNameTableHeader;

	@FindBy(xpath = "//table//th[contains(text(),'Batch Name')]/p-sorticon")
	public WebElement batchNameSortIcon;

	@FindBy(xpath = "//table//th[contains(text(),'Class Topic')]")
	public WebElement classTopicTableHeader;

	@FindBy(xpath = "//table//th[contains(text(),'Class Topic')]/p-sorticon")
	public WebElement classTopicSortIcon;

	@FindBy(xpath = "//table//th[contains(text(),'Class Description')]")
	public WebElement classDescriptionTableHeader;

	@FindBy(xpath = "//table//th[contains(text(),'Class Description')]/p-sorticon")
	public WebElement classDescriptionSortIcon;

	@FindBy(xpath = "//table//th[contains(text(),'Status')]")
	public WebElement statusTableHeader;

	@FindBy(xpath = "//table//th[contains(text(),'Status')]/p-sorticon")
	public WebElement statusSortIcon;

	@FindBy(xpath = "//table//th[contains(text(),'Class Date')]")
	public WebElement classDateTableHeader;

	@FindBy(xpath = "//table//th[contains(text(),'Class Date')]/p-sorticon")
	public WebElement classDateSortIcon;

	@FindBy(xpath = "//table//th[contains(text(),'Staff Name')]")
	public WebElement staffNameTableHeader;

	@FindBy(xpath = "//table//th[contains(text(),'Staff Name')]/p-sorticon")
	public WebElement staffNameSortIcon;

	@FindBy(xpath = "//table//th[contains(text(),'Edit / Delete')]")
	public WebElement editOrDeleteTableHeader;

	@FindBy(xpath = "//th[@class='p-sortable-column']")
	public List<WebElement> tableHeaders;

	@FindBy(xpath = "//th[@class='p-sortable-column']/p-sorticon")
	public List<WebElement> sortIcons;

	@FindBy(xpath = "//tbody//td[2]")
	public List<WebElement> batchNameTableData;

	@FindBy(xpath = "//tbody//td[3]")
	public List<WebElement> classTopicTableData;

	@FindBy(xpath = "//tbody//td[4]")
	public List<WebElement> classDescriptionTableData;

	@FindBy(xpath = "//tbody//td[5]")
	public List<WebElement> statusTableData;

	@FindBy(xpath = "//tbody//td[6]")
	public List<WebElement> classDateTableData;

	@FindBy(xpath = "//tbody//td[7]")
	public List<WebElement> staffNameTableData;
	...
	@FindBy(xpath = "//label[text()='Recording']")
	public WebElement recordingLabel;

	@FindBy(xpath = "//input[@id='classRecordingPath']")
	public WebElement recordingTextbox;

	// Footer WebElement

	@FindBy(xpath = "//p-table/div/div[2]/div")
	public WebElement totalClassesTextInFooter;

	// Pagination WebElements

	@FindBy(xpath = "//span[@class='p-paginator-current ng-star-inserted']")
	public WebElement paginationTextInFooter;

	@FindBy(xpath = "//span[@class='p-paginator-icon pi pi-angle-double-left']/..")
	public WebElement doubleLeftAngleIconPagination;

	@FindBy(xpath = "//span[@class='p-paginator-icon pi pi-angle-left']/..")
	public WebElement leftAngleIconPagination;

	@FindBy(xpath = "//span[@class='p-paginator-icon pi pi-angle-right']/..")
	public WebElement RightAngleIconPagination;

	@FindBy(xpath = "//span[@class='p-paginator-icon pi pi-angle-double-right']/..")
	public WebElement doubleRightAngleIconPagination;

	@FindBy(xpath = "//span[@class='p-paginator-pages ng-star-inserted']/button")
	public List<WebElement> paginationPageNumbers;

	@FindBy(xpath = "//button[contains(@class, 'p-highlight')]")
	public WebElement highlightedPageNumber;

	@FindBy(xpath = "//button[contains(@class, 'p-disabled')]/span[@class='p-paginator-icon pi pi-angle-right']")
	public WebElement disabledRightAnglePaginationIcon;
